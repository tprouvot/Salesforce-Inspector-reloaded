...
- `Data Export` Fix column shifting in data export when downloading/copying hiding object columns [issue #599](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/599) (contribution by [Prem Kumar](https://github.com/prem-k-r))
