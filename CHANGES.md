...
- Add expandable UI for polymorphic field object lists in `Show All Data` popup [feature 865](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/865) - limits display to 3 object types initially with expand/collapse functionality for fields like Task.WhatId and Event.WhoId to reduce visual clutter
