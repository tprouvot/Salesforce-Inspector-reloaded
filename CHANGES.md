...
- `Popup` Fixed Record Type information disappearing when SObjects List Cache is enabled [issue #1247](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/1247) (contribution by [Prem Kumar](https://github.com/prem-k-r))
