...
- `Accessibility` Add ARIA combobox pattern to popup autocomplete search and convert action links to semantic buttons across popup, data export, REST explore, inspect, and field creator pages [#1107](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/1107) & [#1108](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/1108) (contribution by [akj](https://github.com/akj))
