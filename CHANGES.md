...
- Add AlertBanner component for Alerts following [SLDS guidelines](https://www.lightningdesignsystem.com/components/alert/). Lost Session warning converted to AlertBanner. [Nathan Shulman](https://github.com/nshulman)
