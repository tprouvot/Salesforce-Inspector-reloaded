...
- `Data Export` Smart SOQL autocomplete suggestions appear throughout all query stages based on cursor position [feature 912](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/912)
