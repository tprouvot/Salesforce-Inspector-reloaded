...
- `Data Import` Prompt to start new or continue previous import when pasted data contains previous results [issue #1357](https://github.com/tprouvot/Salesforce-Inspector-reloaded/issues/1357) (contribution by [Prem Kumar](https://github.com/prem-k-r))
