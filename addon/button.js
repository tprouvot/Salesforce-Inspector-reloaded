...
function initButton(sfHost, inInspector) {
  ...
  function colorizeBanner(faviconColor){
    const bannerSelector = "#oneHeader > div.slds-color__background_gray-1.slds-text-align_center.slds-size_full.slds-text-body_regular.oneSystemMessage > div.slds-notify_alert.system-message.level-info.slds-theme_info";

    observeElement(bannerSelector, (banner) => {
      // Your logic to colorize the banner goes here
