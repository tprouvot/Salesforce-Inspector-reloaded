...
if (document.querySelector("body.sfdcBody, body.ApexCSIPage, #auraLoadingBox, #studioBody") || location.host.endsWith("visualforce.com")) {
...
function initButton(sfHost, inInspector) {
  ...
  function setFavicon(sfHost) {
    ...
    let {[sfHost + "_customFavicon"]: fav, [sfHost + "_isSandbox"]: isSandbox, [sfHost + "_trialExpirationDate"]: trialExpDate} = iFrameLocalStorage;
    if (fav) {
