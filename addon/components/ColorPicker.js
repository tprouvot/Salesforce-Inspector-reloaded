...
class ColorPicker extends React.Component {
  ...
  componentDidMount() {
    ...
    window.addEventListener("resize", this.adjustPosition, true);

    this.adjustPositionFrame = requestAnimationFrame(() => this.adjustPosition());
  }
  ...
  componentWillUnmount() {
    ...
    window.removeEventListener("resize", this.adjustPosition, true);
    if (this.adjustPositionFrame) {
      cancelAnimationFrame(this.adjustPositionFrame);
      this.adjustPositionFrame = null;
    }
  }
