...
export class ProgressRing extends React.Component {
  ...
  calculateProgressHeadRadius() {
    ...
    const centerX = radiusOfProgressHead * arcX;
    const centerY = radiusOfProgressHead * arcY;
  ...
  render() {
    ...
    const isSuccess = total > 0 && success === total;
    ...
    const progressRingElement = h("div", {className: progressRingClasses, title: tooltipText},
      ...
      !isSuccess && showProgressHead ? h("div", {className: "slds-progress-ring__progress-head", ref: this.setHeadRef},
        h("svg", {viewBox: "-1 -1 2 2", style: {overflow: "visible"}},
