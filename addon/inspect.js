...
import {UserInfoModel, PromptTemplate, Constants, getSalesforceViewLink} from "./utils.js";
...
class FieldRow extends TableRow {
  ...
  idLink() {
    return getSalesforceViewLink(this.rowList.model.sfHost, this.dataTypedValue, this.rowList.model.objectName());
  }
