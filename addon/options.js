    ...
    this.tabs = [
      ...
      },
      {
        ...
        content: [
          ...
          {option: Option, props: {type: "toggle", title: "Enable field to field comparison", key: "enableFieldComparison", default: false, tooltip: "Allow conditions like 'WHERE Field1__c = Field2__c' (also '!='). The condition is removed from the query sent to Salesforce, both fields are added to the SELECT clause, and the records are compared in the browser. Only supported for top level AND conditions."}},
          {option: Option, props: {type: "toggle", title: "Case sensitive field comparison", key: "fieldComparisonCaseSensitive", default: false, tooltip: "By default text fields are compared without case sensitivity, like SOQL does. Enable to compare them exactly."}},
