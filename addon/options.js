    ...
    this.tabs = [
      ...
      },
      {
        ...
        content: [
          ...
          {option: Option, props: {type: "toggle", title: "Auto-split and merge large IN (...) clauses", key: Constants.AUTO_SPLIT_LARGE_IN_CLAUSES, default: false, tooltip: "Automatically breaks down large IN clauses into smaller batches to prevent errors. Note: Supported only for queries containing a single IN clause."}},
