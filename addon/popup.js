      ...
      h("div", {},
        ...
        h("div", { className: "main" },
          ...
          h("div", { className: "global-box" },
            ...
            h("a", { ref: "generateToken", href: `https://${sfHost}/services/oauth2/authorize?response_type=token&client_id=` + localStorage.getItem(sfHost + "_clientId") + "&redirect_uri=chrome-extension://fcmoglpkegmpmenokkgkbkjbdhdgneab/data-export.html?host=" + sfHost + "%26", target: linkTarget, className: "button" }, h("u", {}, "G"), "enerate Connected App Token"),
