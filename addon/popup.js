      ...
      h("div", {},
        ...
        h("div", { className: "main" },
          ...
          h("div", { className: "global-box" },
            ...
            h("a", { ref: "generateToken", href: `https://${sfHost}/services/oauth2/authorize?response_type=token&client_id=3MVG9t0sl2P.pByoBbfCdlcNG._MMlvbPX3AWtwusR.mYXa9kqmFAoqSMGFCzB15NolQvuZUokFQnKHdrkU5Y&redirect_uri=chrome-extension://fcmoglpkegmpmenokkgkbkjbdhdgneab/data-export.html?host=tprouvot-220825-100-demo.my.salesforce.com%26&login_hint=tprouvot@tprouvot-220825-100.sdo`, target: linkTarget, className: "button" }, h("u", {}, "G"), "enerate Connected App Token"),
    ...
    return (
      h("div", { className: "all-data-box " + (this.isLoading() ? "loading " : "") },
        h("ul", { className: "small-tabs" },
          ...
          h("li", { onClick: this.onAspectClick, "data-aspect": this.SearchAspectTypes.users, className: (activeSearchAspect == this.SearchAspectTypes.users) ? "active" : "" }, "Connected App")
        ),
