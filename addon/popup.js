...
class App extends React.PureComponent {
  ...
  render() {
    ...
    let {isInSetup, contextUrl, apiVersionInput, exportHref, importHref, eventMonitorHref, fieldCreatorHref, auditTrailHref, userManagementHref, limitsHref, isFieldsPresent, latestNotesViewed, useLegacyDownloadMetadata} = this.state;
    let hostArg = new URLSearchParams();
    hostArg.set("host", sfHost);
    let linkInNewTab = JSON.parse(localStorage.getItem("openLinksInNewTab"));
    let linkTarget = inDevConsole || linkInNewTab ? "_blank" : "_top";
      ...
      h("div", {},
        ...
        h("div", {className: "main", id: "mainTabs"},
          ...
          h("div", {className: "slds-p-vertical_x-small slds-p-horizontal_x-small slds-border_bottom"},
            ...
            h("div", {className: "slds-m-bottom_xx-small"},
              h("a", {ref: "auditTrailBtn", href: auditTrailHref, target: linkTarget, className: "page-button slds-button slds-button_neutral"}, h("span", {}, "Audit Trail"))
            ),
            h("div", {},
              h("a", {ref: "userManagementBtn", href: userManagementHref, target: linkTarget, className: "page-button slds-button slds-button_neutral"}, h("span", {}, "User Management"))
            ),
            h("div", {className: "slds-m-bottom_xx-small"},
              h("a", {ref: "auditTrailBtn", href: auditTrailHref, target: linkTarget, className: "page-button slds-button slds-button_neutral"}, h("span", {}, "Audit Trail"))
            ),
