    ...
    return h("div", {},
      ...
      h("div", {className: "area"},
        ...
        h("div", {className: "query-controls slds-form-element__control"},
          h("select", {value: "", onChange: this.onSelectQueryTemplate, className: "query-history", title: "Choose rest method"},
          ...
          h("input", {ref: "query", className: "slds-input query-control", type: "default", placeholder: "/services/data/v" + apiVersion, value: this.queryInput}),
        ),
        h("div", {className: "autocomplete-box" + (model.expandAutocomplete ? " expanded" : "")},
          h("div", {className: "autocomplete-header"},
            h("span", {}, model.autocompleteResults.title),
            h("div", {className: "flex-right"},
              h("button", {tabIndex: 1, disabled: model.isWorking, onClick: this.onSend, title: "Ctrl+Enter / F5", className: "highlighted"}, "Send"),
              h("button", {tabIndex: 2, href: "#", className: model.expandAutocomplete ? "toggle contract" : "toggle expand", onClick: this.onToggleExpand, title: "Show all suggestions or only the first line"},
        ...
        h("div", {hidden: !model.showHelp, className: "help-text"},
          h("h3", {}, "Make Salesforce API calls"),
          h("p", {}, "Use for quick one-off rest query. Enter a rest query ", h("a", {href: "https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/dome_query.htm", target: "_blank"}, ""), " in the box above and press Send."),
          h("p", {}, "/services/data/v" + apiVersion + "/limits")
        )
      ),
