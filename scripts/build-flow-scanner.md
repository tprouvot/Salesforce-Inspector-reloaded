...
**Run this script from the root of [`lightning-flow-scanner-core`](https://github.com/flow-scanner/lightning-flow-scanner-cor) — not from the Chrome extension repo.**
